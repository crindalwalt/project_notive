        ...
        children: [
          ...
          Row(
            children: [
              ...
              _buildActionButton(Icons.format_list_bulleted, 'Bullet List', isDark, () {}),
              _buildActionButton(Icons.format_list_numbered, 'Numbered List', isDark, () {}),
              _buildActionButton(Icons.format_indent_decrease, 'Decrease Indent', isDark, () {}),
              _buildActionButton(Icons.format_indent_increase, 'Increase Indent', isDark, () {}),
              ...
              // Insert elements
              _buildActionButton(Icons.table_chart, 'Insert Table', isDark, () {}),
          ...
          children: colors.map((color) {
            return GestureDetector(
              ...
              child: Container(
                ...
                height: 32,
                decoration: BoxDecoration(
                  color: color == Colors.transparent ? (isDark ? const Color(0xFF2D2D30) : const Color(0xFFF3F4F6)) : color,
                  border: Border.all(
